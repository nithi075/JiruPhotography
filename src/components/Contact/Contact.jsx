...
export default function Contact() {
  const whatsappNumber = "919384583567"; 
  const message = "Hello Jiru Photography, I'm interested in booking a luxury session. Let's discuss!";
        ...
        <div className="contact-content-grid">
          ...
          <div className="contact-info">
            <div className="info-block">
              ...
              <a href="mailto:Jiruphotography@gmail.com" className="info-value email">
                Jiruphotography@gmail.com
              </a>
            ...
            <div className="info-block">
              ...
              <p className="info-value">Madurai, Tamil Nadu</p>
            </div>
        ...
        <div className="contact-footer">
          ...
          <div className="footer-flex">
            <div className="footer-brand">
             Jiru<span className="brand-sub">Photography</span>
            </div>
